...
log_dem, reconstruction = dem_model.compute(image, return_reconstruction=True)
...
plt.plot(10 ** np.arange(4, 9.01, 0.05), (10 ** log_dem).sum((1, 2)))
plt.xlim(0, 25e6)
# plt.semilogy()
plt.xlabel('T')
plt.ylabel('DEM')
...
sum_dem = block_reduce(10**log_dem, (10, 1, 1))
